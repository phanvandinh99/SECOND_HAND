...
<head>
    ...
    <link rel="shortcut icon" type="image/icon" href="logo/logo.jpg" />
    <script src="//cdn.jsdelivr.net/npm/alertifyjs@1.13.1/build/alertify.min.js"></script>

    <!-- mobile menu -->
    <div class="mobile-menu bg-second">
        <a href="index.php" class="logo1"><img src="\SECOND HAND\images\logo.jpg" alt="">
            <style>
            .logo1 {
                width: 80px;
                height: 80px;
    ...
    <div class="header-wrapper" id="header-wrapper">
        ...
        <!-- <div class="bg-second">
                <div class="top-header container">
                    <ul class="devided">
                        <li>
                            <a href="#">(+84)378983611</a>
                        </li>
                        <li>
                            <a href="#">Phamtrantuankiet203@gmail.com</a>
                        </li>
                    </ul>                    
                </div>
            </div> -->
                                ...
                                <div class="col-md-12">
                                    <div class="box">
                                        <ul>
                                            ...
                                            ?>
                                            <li><a
                                                    href="./products.php?type=<?= $item['slug'] ?>"><?= $item['name']; ?></a>
                                            </li>
                                            <?php
                                                }
                                            } else {
