...
else if(isset($_POST['delete_product_btn']))
{
    ...
    // Xóa dữ liệu liên quan trong order_detail trước
    $delete_order_detail = "DELETE FROM order_detail WHERE product_id='$product_id'";
    mysqli_query($conn, $delete_order_detail);
